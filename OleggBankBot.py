            ...
            if update.message:  # your bot can receive updates without messages
                ...
                while True:
                    if question == '/start':
                       ...
                       otvet = 'Давай я научу.  "Всего банки решают пять типовых задач клиентов. (1) есть деньги надо вложить, чтоб не пропали. (2) нет денег, надо занять. (3) перевести деньги жене, собаке, в Таджикистан, оплатить какую-нибудь фигню и т.п. (4) поменять валюту. (5) ну и конечно карточку открыть. и конечно у Тинькова. / Все понятно?'
                       ...
                       bot.sendMessage(chat_id=chat_id, text = otvet, reply_markup=hidekeys(chat_id))
                       save_history(file, questnum, message_id, datemsg, question, otvet, chat_id, update_id, username, 
                        user_firstname, user_lastname, user_id)
                       return update.message.text
